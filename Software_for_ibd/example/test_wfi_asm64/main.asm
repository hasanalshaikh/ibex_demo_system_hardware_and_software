...
0000000080000014 <__crt0_pointer_init>:
    ...
    80000020:	93018193          	addi	gp,gp,-1744 # 8000094c <__global_pointer$>
...
000000008000007c <__crt0_copy_data>:
    ...
    80000080:	0d058593          	addi	a1,a1,208 # 8000014c <__etext>
    80000084:	00000617          	auipc	a2,0x0
    80000088:	0c860613          	addi	a2,a2,200 # 8000014c <__etext>
    8000008c:	00000697          	auipc	a3,0x0
    80000090:	0c068693          	addi	a3,a3,192 # 8000014c <__etext>
...
00000000800000a6 <__crt0_clear_bss>:
    ...
    800000aa:	0a670713          	addi	a4,a4,166 # 8000014c <__etext>
    800000ae:	00000797          	auipc	a5,0x0
    800000b2:	09e78793          	addi	a5,a5,158 # 8000014c <__etext>
...
main:
    ...
    80000130:	008000ef          	jal	ra,80000138 <goto_user_mode>
	wfi
    80000134:	10500073          	wfi

0000000080000138 <goto_user_mode>:

goto_user_mode:
	csrw	mepc,ra
    80000138:	34109073          	csrw	mepc,ra
	lui	ra,0x2
    8000013c:	6089                	lui	ra,0x2
	addi	ra,ra,-2048
    8000013e:	80008093          	addi	ra,ra,-2048 # 1800 <__neorv32_heap_size+0x1800>
	csrc	mstatus,ra
    80000142:	3000b073          	csrc	mstatus,ra
	mret
    80000146:	30200073          	mret
    8000014a:	0000                	unimp
